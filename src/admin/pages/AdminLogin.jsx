    ...
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.04] backdrop-blur-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-white/50">Admin Login Panel</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-5">
          <div className="relative">
            <Mail className="absolute left-4 top-4 text-cyan-300" size={20} />
            <input
              type="email"
              name="email"
          ...
          <div className="relative">
            <Lock className="absolute left-4 top-4 text-cyan-300" size={20} />
            <input
              type="password"
              name="password"
